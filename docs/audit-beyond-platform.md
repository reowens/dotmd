...
### 22. `dotmd hud` runs full-validation `buildIndex` just to get an error count — ~6× slower than needed on the SessionStart path. — P3 (perf) — IMPLEMENTED (pending release)
