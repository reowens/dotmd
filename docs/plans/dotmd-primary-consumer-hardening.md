...
runlist:
  ...
  - ../archived/dotmd-primary-consumer-hardening-15-cross-platform-contract.md
...
13. [Cross Platform Contract](../archived/dotmd-primary-consumer-hardening-15-cross-platform-contract.md) ⬜
