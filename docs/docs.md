...
| Doc | Status |
|-----|--------|
| [B3 Set Note Worklog](plans/b3-set-note-worklog.md) | Planned |
...
Archived docs are indexed by the CLI/JSON output. Showing 8 recent or high-signal highlights out of 47 archived docs:
