...
| Doc | Status Snapshot |
|-----|-----------------|
| [Cross Platform Contract](archived/dotmd-primary-consumer-hardening-15-cross-platform-contract.md) | Archived: Audit F13 confirmed Windows-sensitive root ownership and watch URL handling while CI runs only on Ubuntu. Runtime support and maintainer release support need separate explicit policies. |
